...
namespace MdbManager.Medicine
{
    ...
    public class StockUtilities
    {
        ...
        {
            DataSet1TableAdapters.medicinestockTableAdapter msta = new DataSet1TableAdapters.medicinestockTableAdapter();
            int totalQuantity = (int)msta.GetTotalStockByProductNoAndBatchNo(productno, batchno);
        ...
        public static int getTotalSoldProductByProductnoAndBatchno(int productno, string batchno)
        {
            ...
            DataSet1TableAdapters.receipt_itemsTableAdapter rita = new DataSet1TableAdapters.receipt_itemsTableAdapter();
            int totalQuantity;
            if (rita.GetSoldQuantityByMedicineStockSno(msr.sno) == null)
                totalQuantity = 0;
            else
                totalQuantity = (int)rita.GetSoldQuantityByMedicineStockSno(msr.sno);
            if (totalQuantity == null)
                totalQuantity = 0;
            return totalQuantity;
        }
