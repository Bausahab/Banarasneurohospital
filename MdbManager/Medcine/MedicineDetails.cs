...
namespace MdbManager.Medicine
{
    ...
    public class MedicineDetails
    {
        ...
        public MedicineDetails(int sno, int medicineinsidestrip, int stripinsidebox, int extra, float price)
        {
            try
            {
                DataSet1TableAdapters.medicinestockTableAdapter da = new DataSet1TableAdapters.medicinestockTableAdapter();
                ...
                this.hsn = dr.hsn;
                this.rackno = dr.rackno;

                //this.price = rateafterdiscount % medicineinsidestrip+extra;
                this.price = price;
                DataSet1TableAdapters.productsTableAdapter pda = new DataSet1TableAdapters.productsTableAdapter();
