...
namespace MdbManager.Medicine
{
    ...
    public class PurchaseCart
    {
        ...
        public void SaveToDatabase(int billno)
        {
            ...
            DataSet1TableAdapters.purchaseitemTableAdapter da = new DataSet1TableAdapters.purchaseitemTableAdapter();
            DataSet1TableAdapters.medicinestockTableAdapter dda = new DataSet1TableAdapters.medicinestockTableAdapter();
            foreach (PurchaseItemDetails cartitem in cartitems.Values)
            {
                ...
                da.Insert(billno, cartitem.ProductName, cartitem.BatchNo, cartitem.price(), cartitem.MRP, Convert.ToDateTime(cartitem.MfgDate), Convert.ToDateTime(cartitem.ExpiryDate), cartitem.BoxNo, cartitem.StripInsideBox, cartitem.MedicineInsideStrip, cartitem.Unit(), cartitem.Hsn, /*cartitem.ProductNo*/newsno);
