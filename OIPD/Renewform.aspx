        ...
        <div class="w3-col s6 w3-center w3-padding w3-card-4 w3-centered w3-border">
            ...
            <center>
                ...
                <div class="w3-mobile w3-row">
                    <div class="w3-col s6 w3-mobile w3-padding w3-centered ">
                        ...
                        <br />
                        <br />
                        <asp:Label CssClass="w3-large w3-text-blue" ID="lblage" Width="16%" runat="server" Text="Age"></asp:Label>
                        ...
                        <asp:Label CssClass=" w3-hide w3-sand w3-round w3-col s4 w3-input w3-border" ID="txtMonths" Text="0" runat="server" TabIndex="6"></asp:Label>
                        <asp:Label CssClass=" w3-hide  w3-sand w3-round w3-col s4 w3-input w3-border" ID="txtDays" Text="0" runat="server" TabIndex="6"></asp:Label>
                        <br />
                        <br />
                        <br />
                        <asp:Label CssClass="w3-large w3-text-blue" ID="lbladdress" Width="16%" runat="server" Text="Address"></asp:Label>
                    ...
                    <div class="w3-col s6 w3-mobile w3-padding  ">
                        ...
                        <asp:TextBox CssClass="w3-sand w3-round w3-input w3-border" ID="txtdate" runat="server" TextMode="Date" TabIndex="1"></asp:TextBox>
            ...
            <div class="w3-row w3-mobile w3-center">
                <asp:Button ID="HyperLink1" CssClass="w3-round-xxlarge w3-btn w3-purple" OnClick="renew" runat="server" Text="Renew" Width="196px" />
                <br />
                <br />
                <br />
                <asp:HyperLink ID="btnreset" CssClass=" w3-round-xxlarge w3-btn w3-purple" runat="server" Text="Home" NavigateUrl="home.aspx" Height="28px" Width="157px" />
