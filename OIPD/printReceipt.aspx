...
<tr class="top">
    <td>
        ...
        <td colspan="2">
        <div>
        <center><label style="font-size:2">AN ISO : 9001:2022 CERTIFIED HOSPITAL</label><br/>
        <label style="font-size:2">Reged No. : </label>
            RMEE2235763<br/>
        ...
        <br />
            B37, 81-19 Ahilyabai Colony Bhogabir Lanka, Varanasi
        <br />
