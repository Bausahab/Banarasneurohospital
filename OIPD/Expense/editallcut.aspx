<%@ Page Title="" Language="C#" MasterPageFile="~/Expense/MasterPage.master" AutoEventWireup="true" CodeBehind="editallcut.aspx.cs" Inherits="OIPD.Expense.editallcut" %>
...
<div class="w3-col s12 w3-mobile w3-padding w3-center w3-round-large w3-card-4">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        SelectCommand="SELECT * FROM [doctorcut] order by sno desc"
