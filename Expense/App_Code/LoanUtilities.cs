...
public class LoanUtilities
{
    ...
    public static string GetLoanPersonNameByLoanNo(int loanno)
    {
        try
        {
            ...
            string name = LoanUtilities.GetLoanPersonNameBySno(dr.loangivenpersonno);
            return name;
        }
        catch
        {
    ...
    public static double GetReamainingLoanAmountToPayByPersonNo(int pno)
    {
        try
        {
            double totalloantaken = LoanUtilities.GetLoanAmountTakenFromPersonNo(pno);
            double loanpaid=LoanUtilities.GetPaidLoanAmountFromPersonNo(pno);
