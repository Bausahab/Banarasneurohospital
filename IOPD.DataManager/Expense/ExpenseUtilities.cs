...
namespace IOPD.DataManager.Expense
{
    public class ExpenseUtilities
    {
        ...
        public static double GetTotalAmountPaidByPatientInPathologyAfterDiscountByPatientNo(int pno)
        {
            try
            {
                double amountpaid = ExpenseUtilities.GetTotalAmountPaidByPatientInPathologyByPatientNo(pno);
                double discount = ExpenseUtilities.GetDiscountAmountOnPatientFromPathology(pno);
        ...
        public static double GetTotalAmountPaidByPatientInMedicineByPatientNo(int receiptno)
        {
            try
            {
                ...
                double discount = ExpenseUtilities.GetDiscountAmountOnCustomerFromMedicineByCustomerNo(receiptno);
                return amount - discount;
            }
            catch
            {
        ...
        public static double GetTotalAmountPaidByPatientInMedicineAfterDiscountByPatientNo(int receiptno)
        {
            try
            {
                double amountpaid = ExpenseUtilities.GetTotalAmountPaidByPatientInMedicineByPatientNo(receiptno);
                double discount = ExpenseUtilities.GetDiscountAmountOnCustomerFromMedicineByCustomerNo(receiptno);
                return amountpaid - discount;
            }
            catch
        ...
        public static double GetTotalAmountApplidOnPatientInHospitalByIpNo(string ipnumber)
        {
            try
            {
                ...
                double amount = ExpenseUtilities.GetTotalAmountAppliedOnPatientInHospitalByPatientNo(patientno);
                return amount;
            }
            catch
            {
        ...
        public static double GetTotalIncomeFromPathologyByDate(DateTime date)
        {
            try
            {
                ...
                double discount = ExpenseUtilities.GetDiscountInPathologyOnDate(date);
                return amount - discount;
        ...
        public static double GetTotalIncomeFromPathologyOfEveryDate()
        {
            try
            {
                ...
                for (int i = 0; i <= pdt.Rows.Count - 1; i++)
                {
                    ...
                    discount += ExpenseUtilities.GetDiscountAmountOnPatientFromPathology(pno);
                }
        ...
        public static double GetPatientTestItemRates(int patientno, int testno)
        {
            try
            {
                bool b = ExpenseUtilities.FullTestApplied(patientno, testno);
        ...
        public static double GetTotalIncomeFromMedicineByDate(DateTime date)
        {
            try
            {
                ...
                for (int i = 0; i <= dt.Rows.Count - 1; i++)
                {
                    ...
                    totalamount += ExpenseUtilities.GetTotalPriceOnReceiptInMedicine(receiptno);
                }
                double discount = ExpenseUtilities.GetDiscountInMedicineOnDate(date);
        ...
        public static double GetTotalIncomeFromMedicineOfAllDate()
        {
            try
            {
                ...
                for (int i = 0; i <= dt.Rows.Count - 1; i++)
                {
                    DataSet1.customerdetailsRow dr = (DataSet1.customerdetailsRow)dt.Rows[i];
                    int receiptno = dr.receiptno;
                    double amount = ExpenseUtilities.GetTotalPriceOnReceiptInMedicine(receiptno);
                    totalamount += amount;
                }
                double discount = ExpenseUtilities.GetTotalDiscountInMedicineOfAllDate();
                return totalamount - discount;
            }
            catch
            {
        ...
        public static double GetAllTotalExpencesOfAllTimeIncludingAll()
        {
            try
            {
                double amount = ExpenseUtilities.GetAllTotalExpenseOfEverydate();
