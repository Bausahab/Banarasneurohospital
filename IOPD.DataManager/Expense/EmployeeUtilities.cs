...
namespace IOPD.DataManager.Expense
{
    ...
    public class EmployeeUtilities
    {
        public static string GetEmployeeNameByEmployeeNo(int employeeno)
        {
            try
            {
                IOPD.DataManager.Expense.DataSet1TableAdapters.employeeTableAdapter da = new IOPD.DataManager.Expense.DataSet1TableAdapters.employeeTableAdapter();
        ...
        public static double GetTotalAmountPaidToEmployeeByEno(int eno)
        {
            try
            {
                IOPD.DataManager.Expense.DataSet1TableAdapters.employeepaymentTableAdapter da = new IOPD.DataManager.Expense.DataSet1TableAdapters.employeepaymentTableAdapter();
